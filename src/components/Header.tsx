      ...
      <nav className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="flex items-center gap-4 md:hidden">
            ...
            <a href="https://www.instagram.com/gentlemens_club_philippopolis" target="_blank" rel="noopener noreferrer" className="text-brand-900 hover:text-brand-600 transition-colors">
